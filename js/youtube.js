...
function loadYouTubeAPI() {
  return new Promise(resolve => {
    if (window.YT && window.YT.Player) {
      ...
      // YouTube API 会自动加载到 window.YT，并触发 onYouTubeIframeAPIReady
      // 此处的 tag.src 实际上在 index.html 中已经通过 <script src="https://www.youtube.com/iframe_api"></script> 引入了
      // 所以这段代码可能冗余，但作为兜底逻辑保留
